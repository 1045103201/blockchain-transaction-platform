      ...
      <el-main>
        ...
        <el-form ref="form" :model="form" >
          ...
          <el-row type="flex" justify="center">
            <el-col span="4">
              <el-form-item>
                <el-input v-model="form.name"  placeholder="版本号"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row type="flex" justify="center">
            <el-col span="4">
              <el-form-item>
                <el-input v-model="form.name"  placeholder="更新时间"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row type="flex" justify="center">
            <el-col span="4">
              <el-form-item>
                <el-input v-model="form.name"  placeholder="开发单位/个人"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row type="flex" justify="center">
            <el-col span="4">
              <el-form-item>
                <el-input v-model="form.name"  placeholder="备注"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
